...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Sep 13 10:14:41 CEST 2015
  */
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		Token lit = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		...
		ParametroWrite pw = (ParametroWrite)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		...
		SentenciasThenElseFor sent = (SentenciasThenElseFor)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ...
		 RESULT = new ParteElse(); 
          ...
          case 82: // parte_else ::= ELSE sentencias_then_else_for 
            {
              ParteElse RESULT =null;
		int stefleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int stefright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		SentenciasThenElseFor stef = (SentenciasThenElseFor)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
          ...
          case 81: // sentencias_then_else_for ::= sentencia 
            {
              SentenciasThenElseFor RESULT =null;
		...
		int stefleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int stefright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		SentenciasThenElseFor stef = (SentenciasThenElseFor)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		...
		Token id = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
									...
									ScopeIF scope = scopeManager.getCurrentScope();		
									SentenciaAsignacionIzq sai = new SentenciaAsignacionIzq (scopeManager.searchType("INTEGER"),id.getLexema());
									IntermediateCodeBuilder cb = new IntermediateCodeBuilder(scope);
		...
		Expresion e = (Expresion)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
							...
							if (!scopeManager.containsSymbol(sai.getId())){
								...
								if (tipo instanceof TypeInteger){	
									...
									if (!sai.isAccesopuntero())
										cb.addQuadruple("AREG",sai.getOperando(), e.getOperando());		
									else	
										cb.addQuadruple("STP_REG", sai.getOperando(), e.getOperando());												
								}else{	//PUNTERO	
									System.out.println(e.getTipo());
									if(!(e.getTipo() instanceof TypeInteger) && !(e.getTipo() instanceof TypeFunction) && !(e.getTipo() instanceof TypePointer)){ 
										semanticErrorManager.semanticFatalError("Tipos incompatibles. Integer no es compatible con " + e.getTipo().getName());
									}
									if (!sai.isAccesopuntero())
										cb.addQuadruple("ASN",sai.getOperando(), e.getOperando());	
									else
										cb.addQuadruple("STP",sai.getOperando(), e.getOperando());
								}							
							}	
		...
		int sleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int sright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		SentenciaWrite s = (SentenciaWrite)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		...
		LlamadaSubprograma s = (LlamadaSubprograma)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		...
		int sleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int sright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		SentenciaAsignacion s = (SentenciaAsignacion)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
          ...
          case 68: // secuencia_sentencias ::= sentencia 
            {
              SecuenciaSentencias RESULT =null;
		int sleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int sright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Sentencia s = (Sentencia)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		...
		SecuenciaSentencias sc = (SecuenciaSentencias)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		int sleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int sright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Sentencia s = (Sentencia)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				if (!scopeManager.containsSymbol(i1.getLexema())){
					...
					semanticErrorManager.semanticFatalError(i2.getLexema() + " no definido");
						...
						if (!registro.contieneCampo(i2.getLexema())){
							...
							Variable var2 = new Variable(i2.getLexema(),scope);
							exp.setOperando(temp);
							cb.addQuadruple("MVA_REG", temp, var1, var2);
							exp.setIntermediateCode(cb.create());
							RESULT = exp;
						}	
					}
					...
					semanticErrorManager.semanticFatalError(i2.getLexema() + " no definido");
						...
						if (!registro.contieneCampo(i2.getLexema())){
							...
							if (!tipoI2.getName().equals("POINTER")){
								...
								cb.addQuadruple("MVP_REG", temp, var1, var2);
							...
							if (!scopeManager.containsSymbol(id.getLexema())){
								...
								if (!(tipo instanceof TypeFunction) && !(tipo instanceof TypeProcedure)){		
									...
									if(!funcion.compararParametros(spl.getParametros())){											
										...
										List<Expresion> listaParam = new ArrayList<Expresion>();
										listaParam = spl.getParametros();										
										...
										proc.setParametros(spl.getParametros());
										Value val = new Value(scope.getName());	
																				
										for(Expresion e : listaParam){
											cb.addQuadruple("ARG", e.getOperando());
										}
																												
										cb.addQuadruple("CALL", proc, val);	
										llamada.setIntermediateCode(cb.create());											
									 	RESULT = llamada;
									}									
								}
		...
		SecuenciaParametros sp = (SecuenciaParametros)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new DeclaracionParametros(sp.getParametros()); 
          ...
          case 38: // decl_procedimiento ::= PROCEDURE ID decl_parametros NT$2 PUNTO_Y_COMA declaraciones bloque PUNTO_Y_COMA 
            {
              DeclaracionProcedimiento RESULT =null;
              // propagate RESULT from NT$2
                RESULT = (DeclaracionProcedimiento) ((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-4)).value;
		...
		Bloque bloq = (Bloque)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
						...
						Procedure p = new Procedure(scope.getName(), scope);						
						LabelIF label = p.getCodeLabel();
						LabelIF label_salida = lf.create(id.getLexema().toUpperCase()+"_FIN");
						cb.addQuadruple("BR", label_salida);
						cb.addQuadruple("INL", label);
						cb.addQuadruples(dec.getIntermediateCode());
						cb.addQuadruples(bloq.getIntermediateCode());
						cb.addQuadruple("FINS", null);
						cb.addQuadruple("INL", label_salida);
					...
					if(!(sTable.containsSymbol(s))){
						...
						if (scope.getLevel()==0) {
							...
							if (t instanceof TypeRecord){
								...
								global_address = global_address+(s_size*t.getSize()-1);
							}else{
					  			global_address = global_address+s_size;
					  			sV.setAddress(global_address);	
					  		}			  			
		...
		SecuenciaCamposRegistro cr = (SecuenciaCamposRegistro)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
          ...
          case 22: // secuencia_tipos ::= tipo 
            {
              SecuenciaTipos RESULT =null;
		 RESULT = new SecuenciaTipos(); 
		...
		LiteralLogico ll = (LiteralLogico)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		...
		LiteralEnteroOLogico lel = (LiteralEnteroOLogico)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
          ...
          case 15: // secuencia_constantes ::= constante 
            {
              SecuenciaConstantes RESULT =null;
		int cleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int cright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		...
		int scleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int scright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		SecuenciaConstantes sc = (SecuenciaConstantes)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		int cleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int cright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Constante c = (Constante)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ...
		 RESULT = new DeclaracionSubprogramas(); 
          ...
          case 12: // decl_subprogramas ::= decl_subprogramas decl_funcion 
            {
              DeclaracionSubprogramas RESULT =null;
		int d_subleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int d_subright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		DeclaracionSubprogramas d_sub = (DeclaracionSubprogramas)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		int d_proleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int d_proright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		DeclaracionFuncion d_pro = (DeclaracionFuncion)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		...
		int d_proleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int d_proright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		DeclaracionProcedimiento d_pro = (DeclaracionProcedimiento)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		...
		DeclaracionSubprogramas ds = (DeclaracionSubprogramas)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		...
		SecuenciaVariables sv = (SecuenciaVariables)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		int dsleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int dsright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		DeclaracionSubprogramas ds = (DeclaracionSubprogramas)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		...
		DeclaracionVariables dv = (DeclaracionVariables)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		...
		int scleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int scright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		SecuenciaTipos sc = (SecuenciaTipos)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		int dvleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int dvright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		DeclaracionVariables dv = (DeclaracionVariables)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		...
		DeclaracionTipos dt = (DeclaracionTipos)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		...
		Bloque bloq = (Bloque)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
                ...
                for (ScopeIF scop: scopes){
                	...
                	for (SymbolIF s: symbols){
                		if(s instanceof SymbolVariable){                			
                			...
                			if (scop.getLevel()!=0){
                				TypeIF t = sv.getType();
                				if (t instanceof TypeRecord){ 
                					sv.setAddress(v_offset++);
                					v_offset = v_offset + t.getSize() - 1;	  
                				}else{
                					sv.setAddress(v_offset++);
                				}
                			}
                	...
                	listaScopes.put((String)scop.getName(),s_size);             	
                }
                             
                Value v_scopes = new Value(listaScopes);
                
                cb.addQuadruple("INICIAR", v_scopes);
                cb.addQuadruples(dec.getIntermediateCode());
                cb.addQuadruples(bloq.getIntermediateCode());
