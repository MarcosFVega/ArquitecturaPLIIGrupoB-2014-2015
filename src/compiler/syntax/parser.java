...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Sep 05 19:14:06 CEST 2015
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		SentenciasThenElseFor sent = (SentenciasThenElseFor)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ...
		 RESULT = new SentenciasThenElseFor(); 
		...
		Token id = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
									...
									cb.addQuadruple("POINT", temp, var);                                    
									sai.setIntermediateCode(cb.create());
									sai.setOperando(temp);
		...
		Expresion e2 = (Expresion)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			if (t1.getName() != t2.getName()){
				...
				cb.addQuadruple ("EQ", e1.getOperando(), e2.getOperando(), tf);
		...
		Expresion e2 = (Expresion)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			if (!t1.getName().equals("INTEGER") || !t2.getName().equals("INTEGER")){
				...
				cb.addQuadruple ("GT", e1.getOperando(), e2.getOperando(), tf);
		...
		Expresion e2 = (Expresion)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			if (!t1.getName().equals("BOOLEAN") || !t2.getName().equals("BOOLEAN")){
				...
				cb.addQuadruple ("OR", e1.getOperando(), e2.getOperando(), tf);
		...
		Expresion e2 = (Expresion)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			if (!t1.getName().equals("INTEGER") || !t2.getName().equals("INTEGER")){
				...
				cb.addQuadruple ("SUB", e1.getOperando(), e2.getOperando(), tf);
